...
function SearchBar({className}: PropsInterface) {
    return (
        <div className={"rounded-normal bg-bgBaseD w-[380px] h-[60px] relative flex" + {className}}>
            <MagnifyingGlassIcon className="-scale-x-100 w-[26px] absolute top-[17px] stroke-tDarkD left-6"/>
